      ...
      <header className="relative z-20 w-full">
        <div className="mx-auto max-w-7xl px-4 py-3 grid grid-cols-12 items-center gap-3">
          ...
          <div className="col-span-12 sm:col-span-4 order-3 flex justify-end items-center gap-2">
            <a href="https://x.com/i/communities/1980356581725200489" target="_blank" rel="noreferrer" className="px-3 py-1.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-[11px]">𝕏</a>
