...
const TRACKED_MINT       = process.env.TRACKED_MINT  || "HQc8Pn4UGojzQUS8q9uGfonA57rWvQmyjgGVBjXbpump";
const REWARD_WALLET      = process.env.REWARD_WALLET || "BuxnqzrZ2nDViA3ZkmF4mERSJ4Jnws23hPWTeYcpSDfB";
