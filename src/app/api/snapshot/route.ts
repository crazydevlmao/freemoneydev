...
const TRACKED_MINT       = process.env.TRACKED_MINT  || "BtBSuYPydXPAnaXU3pf5J2cBHUkz4z4mbvzn2sgepump";
const REWARD_WALLET      = process.env.REWARD_WALLET || "68Tn7rT45uocBe8TDgkQ4jZkNhmHnqLoXaFN23VHKx1V";
